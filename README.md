# 🛡️ Repository Guide: Scans, Remediations, Case Studies and GRC Practice 

This repository serves as a practical, hands-on archive of cybersecurity practice that I accumulated that includes working with Nessus, ISO 27001 practice, and cybsersecurity cases to study. 


## 📂 What You Will Find Here

This repository is divided into five sections:

### 1. 🔍 Vulnerability Scans & Assessments

This section contains assessments from Nessus security assessment tools. It demonstrates my methodology for identifying vulnerabilities across different environments (including cloud infrastructure and enterprise networks).
