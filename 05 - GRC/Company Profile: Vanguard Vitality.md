...
| **Loss of Database Access (Shadow IT):** The company loses access to the primary intake form and historical database because it is owned by a former employee's personal Gmail account. | 2 | 4 | **8** | **Low** | Recreate the form under an official corporate Google Workspace account. Export all existing data to the corporate environment and sever the link to the personal account. |
